...
class VectorTestCase(unittest.TestCase):
    ...
    def testNAInteger(self):
        vec = robjects.IntVector(list(range(3)))
...
class ExtractDelegatorTestCase(unittest.TestCase):
    ...
    def testExtractByIndex(self):
        ...
        myIndex = robjects.Vector(array.array('i', list(range(1, 11, 2))))
    ...
    def testReplace(self):
        vec = robjects.IntVector(list(range(1, 6)))
        i = array.array('i', [1, 3])
    ...
    def testExtractRecyclingRule(self):
        # recycling rule
        v = robjects.Vector(array.array('i', list(range(1, 23))))
