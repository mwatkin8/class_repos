...
class MatrixTestCase(unittest.TestCase):
    ...
    def testNrowGet(self):
        m = robjects.r.matrix(robjects.IntVector(list(range(6))), nrow=3, ncol=2)
    ...
    def testCrossprod(self):
        m = robjects.r.matrix(robjects.IntVector(list(range(4))), nrow=2)
        mcp = m.crossprod(m)
    ...
    def testDot(self):
        m = robjects.r.matrix(robjects.IntVector(list(range(4))), nrow=2, ncol=2)
        m2 = m.dot(m)
